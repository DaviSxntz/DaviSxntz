...
`React` `Node.js` `Express` `Electron` `SQLite` `SQLCipher` `Vitest`
...
`Laravel` `React` `React Native` `Expo` `PostgreSQL` `SQLite` `pnpm`
...
<a href="https://github.com/DaviSxntz">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=DaviSxntz&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true"/>
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=DaviSxntz&layout=compact&langs_count=8&theme=tokyonight"/>
</a>
